...
IN_BTTS = [
    [
        Button.url(
            "Owner",
            url="https://t.me/PowerDefend",
        ),
        Button.url("Support", url="https://t.me/BlackBincards"),
    ]
]
...
<b>Owner</b>: <a href="https://t.me/Powerdefend">Power Defend</a>
<b>Support</b>: <a href="https://t.me/BlackBincards">BlackBincards</a>
(c) BlackBincard
"""
                res = [
                    await event.builder.article(
                        title= f"{client.name} - @{client.botname}",
                        url="https://t.me/BlackBincards",
                        description="(c) BlackBincards",
                        text=MSG,
