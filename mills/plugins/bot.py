...
async def _(m,lang):
    ...
    SUPPORT_CHAT = await m.adb.get_key("SUPPORT_CHAT") or "BlackBincards"
    buttons = [
        [
            Button.url("Support", f'https://t.me/{SUPPORT_CHAT}'),
            Button.url("Black Bincards", 'https://t.me/Powerdefend'),
        ],[
            Button.url("Buy Premium", 'https://t.me/OutMarch'),
            Button.url("Owner", 'https://t.me/OutMarch'),
        ]
    ]
