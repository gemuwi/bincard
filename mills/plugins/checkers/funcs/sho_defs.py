...
'checkout[client_details][browser_tz]': '-330',
    ...
    four = r.post('https://www.worldjewels.com/25447694445/checkouts/d36086967ff1bfad78b5f74416112083?previous_step=shipping_method&step=payment_method', json = json_four)
