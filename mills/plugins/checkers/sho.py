...
async def _sho(m, gate_db, user_db, cards, lang):
    ...
    a = get_c_url(browser, 'https://www.worldjewels.com/25447694445/checkouts/d36086967ff1bfad78b5f74416112083?previous_step=shipping_method&step=payment_method')
